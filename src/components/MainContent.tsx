...
const MainContent: React.FC = () => {
  ...
  if (!selectedPage) {
    return (
      <div className={`flex-1 flex items-center justify-center bg-white dark:bg-slate-900 transition-all duration-300 ease-in-out ${
  ...
  return (
    <div className={`flex-1 bg-white dark:bg-slate-900 transition-all duration-300 ease-in-out ${
      isSidebarCollapsed ? 'ml-0' : ''
    }`}>
      {/* Page Header */}
      <div className="border-b border-gray-200 dark:border-slate-700 px-8 py-6">
        <div className="relative mb-4">
          <button
            ...
            className="hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg p-2 transition-colors"
          >
            {selectedPage.icon ? (
